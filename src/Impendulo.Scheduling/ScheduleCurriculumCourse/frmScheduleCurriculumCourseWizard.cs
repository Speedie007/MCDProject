...
using Impendulo.Development.Scheduling.SubForms;
...
namespace Impendulo.Development.Scheduling
{
    public partial class frmScheduleCurriculumCourseWizard : MetroForm
    {
        ...
        private void btnChangeDuration_Click(object sender, EventArgs e)
        {
            using (frmSchedulingDurationAdjustment frm = new frmSchedulingDurationAdjustment(CurrentSelectedCurriculumCourseEnrollment))
            {
                frm.ShowDialog();
