...
namespace Impendulo.Development.Files.Files.CompanyFiles
{
    public partial class frmCompanyFiles : MetroForm
    {
        ...
        #endregion
        public frmCompanyFiles(Employee CurrentEmployeeLoggedIn)
        {
        ...
        private void populateCompanyFiles()
        {
            ...
            using (var Dbconnection = new MCDEntities())
            {
                ...
                if (CurrentlySelectedCompanyProgressfile != null)
                {
                    ...
                    if (CurrentlySelectedCompanyProgressfile.Enquiries.Count > 0)
                    {
        ...
        private void refreshEnquiries()
        {
            ...
            using (var Dbconnection = new MCDEntities())
            {
                ...
                EnquiryCache = (from a in Dbconnection.Enquiries
                                where a.ProgressFileID == CurrentlySelectedCompanyProgressfile.ProgressFileID
                                select a)
        ...
        {
            Individual LocalCurrentlySelectedIndividual = null;
            if (companyEnquiriesBindingSource.Count > 0)
            {
                CompanyEnquiries CE = (CompanyEnquiries)companyEnquiriesBindingSource.Current;
                ...
                LocalCurrentlySelectedIndividual = E.Individuals.FirstOrDefault();
            }
            ...
            using (frmSelectCompanyContact frm = new frmSelectCompanyContact())
            {
                ...
                frm.SelectedIndividual = LocalCurrentlySelectedIndividual;
                frm.ShowDialog();
                if (frm.CurrentCompany != null && !frm.IsCanceled)
                {
                    ...
                    if (frm.SelectedIndividual != null)
                    {
                        using (frmNewEnquiryV2 frm1 = new frmNewEnquiryV2(
                                        IsProgressComanyProgressFileEnquiry: true,
                                        IsStudentFileEnquiry: false,
                                        CurrentlySelectedCompany: CurrentlySelectedCompany,
            ...
            if (companyEnquiriesBindingSource.Count > 0)
            {
                ...
                if (E.InitialConsultationComplete)
                {
                    ...
                    if (Rtn == DialogResult.Yes)
                    {
                        ...
                        {
                            using (frmApprenticeshipEnrollmentFormV2 frm = new frmApprenticeshipEnrollmentFormV2(E, true, Impendulo.Common.Verifiction.OfProgressFiles.VerifyCompanyProgressFile(CurrentlySelectedCompany.CompanyID)))
                            {
