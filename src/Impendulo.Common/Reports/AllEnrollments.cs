...
namespace Impendulo.Common.Reports {
    using System;
    ...
    public class AllEnrollments : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Impendulo.Common.Reports.AllEnrollments.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedAllEnrollments : Component, ICachedReport {
        
        public CachedAllEnrollments() {
        }
