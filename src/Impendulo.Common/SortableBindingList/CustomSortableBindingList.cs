...
{
    public class CustomSortableBindingList<T> : BindingList<T> 
    {
        ...
        Action<CustomSortableBindingList<T>, List<T>>
        ...
        public CustomSortableBindingList()
        {
            originalList = new List<T>();
        }

        public CustomSortableBindingList(IEnumerable<T> enumerable)
        {
            originalList = enumerable.ToList();
            populateBaseList(this, originalList);
        }

        public CustomSortableBindingList(List<T> list)
        {
            originalList = list;
            populateBaseList(this, originalList);
        }
