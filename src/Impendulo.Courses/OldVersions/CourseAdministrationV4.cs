...
{
    public partial class CourseAdministrationV4 : Form
    {
        MCDEntities DbConnection;
        Boolean _IsLoading = false;
        public CourseAdministrationV4()
        {
            InitializeComponent();
        }

        private void CourseAdministrationV4_Load(object sender, EventArgs e)
        {
        ...
        private void trainingDepartmentCouresListBox_SelectedIndexChanged(object sender, EventArgs e)
        {
            //populateTrainingDepartmentCourses(Convert.ToInt32(lstTrainingDepartments.SelectedValue));
            _IsLoading = true;
            ...
            if (this.dgvCoures.Rows.Count > 0) { CourseID = Convert.ToInt32(dgvCoures.SelectedRows[0].Cells[0].Value.ToString()); }
