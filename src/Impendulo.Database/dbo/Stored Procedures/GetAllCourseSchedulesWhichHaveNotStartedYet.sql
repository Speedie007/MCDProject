...
CREATE PROCEDURE [dbo].[GetAllCourseSchedulesWhichHaveNotStartedYet]
--DROP PROCEDURE GetAllCourseSchedulesWhichHaveNotStartedYet
AS
...
HAVING        (Schedules.ScheduleStartDate >= GETDATE())
UNION
SELECT        
	Schedules.ScheduleStartDate					AS [StartDate], 
	Schedules.ScheduleCompletionDate			AS [EndDate], 
