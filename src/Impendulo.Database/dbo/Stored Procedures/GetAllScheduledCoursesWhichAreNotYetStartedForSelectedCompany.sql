...
CREATE PROCEDURE [dbo].[GetAllScheduledCoursesWhichAreNotYetStartedForSelectedCompany]
--DROP PROCEDURE GetAllScheduledCoursesWhichAreNotYetStartedForSelectedCompany 1
...
HAVING        
		(CompanyStudentProgressFiles.CompanyProgressFileID = @CompanyProgressFileID) AND (Schedules.ScheduleStartDate > GETDATE()) -- Course that Have Not Yet Started
