CREATE PROCEDURE [REPORTS_GetAll_CONFIRMED_CourseSchedules]
--DROP PROCEDURE [REPORTS_GetAll_CONFIRMED_CourseSchedules]
AS
SELECT      
...
GROUP BY Schedules.ScheduleStartDate, Schedules.ScheduleCompletionDate, LookupDepartments.DepartmentName, Curriculums.CurriculumName, Courses.CourseName, 
                         ...
                         LookupEnrollmentProgressStates.EnrollmentProgressCurrentState, CurriculumCourseEnrollments.LookupEnrollmentProgressStateID
