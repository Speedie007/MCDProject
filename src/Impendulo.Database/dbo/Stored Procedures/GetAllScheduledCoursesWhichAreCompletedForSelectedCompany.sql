...
CREATE PROCEDURE [dbo].[GetAllScheduledCoursesWhichAreCompletedForSelectedCompany]
--DROP PROCEDURE GetAllScheduledCoursesWhichAreCompletedForSelectedCompany 1036
...
HAVING        
		(CompanyStudentProgressFiles.CompanyProgressFileID = @CompanyProgressFileID) AND (Schedules.ScheduleCompletionDate < GETDATE())--Course that are Commpleted
