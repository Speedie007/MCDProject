...
CREATE PROCEDURE [dbo].[GetAllScheduledCoursesWhichAreCompletedForSelectedStudent]
--DROP PROCEDURE GetAllScheduledCoursesWhichAreCompletedForSelectedStudent
...
GROUP BY Curriculums.CurriculumName, Courses.CourseName, Schedules.ScheduleStartDate, Schedules.ScheduleCompletionDate, Schedules.IndividualID, Schedules.LookupScheduleLocationID, 
                         ...
                         StudentProgressFiles.StudentProgressFileID, Venues.VenueName, OnSiteSchedules.VenueID, LookupEnrollmentProgressStates.EnrollmentProgressCurrentState, Schedules.CurriculumCourseEnrollmentID
HAVING        (StudentProgressFiles.StudentProgressFileID = @StudentProgressFileID) AND (Schedules.ScheduleCompletionDate < GETDATE())--Course that are Commpleted
