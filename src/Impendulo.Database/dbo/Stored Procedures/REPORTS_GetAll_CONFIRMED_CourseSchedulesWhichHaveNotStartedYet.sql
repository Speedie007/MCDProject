CREATE PROCEDURE [dbo].[REPORTS_GetAll_CONFIRMED_CourseSchedulesWhichHaveNotStartedYet]
--DROP PROCEDURE [REPORTS_GetAll_CONFIRMED_CourseSchedulesWhichHaveNotStartedYet]
--GetAllCourseSchedulesWhichHaveNotStartedYet
AS
SELECT      
...
WHERE        (Schedules.ScheduleStatusID = 2) AND (Schedules.ScheduleStartDate > GETDATE())
