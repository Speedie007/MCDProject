...
CREATE PROCEDURE [dbo].[GetAllScheduledCoursesWhichAreNotYetStartedForSelectedStudent]
--DROP PROCEDURE GetAllScheduledCoursesWhichAreNotYetStartedForSelectedStudent
...
HAVING        (StudentProgressFiles.StudentProgressFileID = @StudentProgressFileID) AND (Schedules.ScheduleStartDate > GETDATE()) -- Course that Have Not Yet Started
